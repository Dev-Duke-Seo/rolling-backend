...
public interface CommentService {
    ...
    BlobApiResponse<CommentResponse> createComment(Long userId, Long postId, CommentRequest request);
    
    BlobApiResponse<BlobPagedResponse<CommentDetailResponse>> getCommentsByPost(Long postId, int page, int size);
    
    BlobApiResponse<Void> deleteComment(Long userId, Long commentId);
    
    BlobApiResponse<ReplyResponse> createReply(Long userId, Long commentId, ReplyRequest request);
    
    BlobApiResponse<BlobPagedResponse<ReplyDetailResponse>> getRepliesByComment(Long commentId, int page, int size);
