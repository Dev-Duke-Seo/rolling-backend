...
public class RecipientController {
        ...
        public ResponseEntity<PageResponseDto<RecipientDto>> getAllRecipients(
                        ...
                        @Parameter(description = "정렬 기준(popular/recent)",
                                        example = "popular") @RequestParam(name = "sort",
                                                        defaultValue = "popular") String sort) {

                ServiceResult<PageResponseDto<RecipientDto>> result =
                                recipientService.getAllRecipients(limit, offset, sort);
