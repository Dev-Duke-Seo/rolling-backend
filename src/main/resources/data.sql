...
INSERT INTO blob_posts (user_id, title, content, category, subcategory, country, city, city_lat, city_lng, latitude, longitude, address, actual_lat, actual_lng, dist_from_actual, like_count, comment_count, view_count, created_date, updated_at, expires_at) VALUES
...
-- foodie_kim의 게시물 (2개)  
(2, '홍대 신상 파스타집 주의!', '홍대에 새로 생긴 파스타집 갔는데 양도 적고 맛도 별로예요. 가격은 비싸고... 추천하지 않아요', 'NOT_RECOMMENDED', 'RESTAURANT', '대한민국', '서울특별시', 37.5563, 126.9238, 37.5563, 126.9238, '서울특별시 마포구 홍익로 3길', 37.5566, 126.9241, 32.8, 6, 4, 89, '2024-03-22 18:20:00', '2024-03-22 18:20:00', '2024-06-22 18:20:00'),
(2, '강남 브런치 맛집 추천!', '강남역 근처에 있는 브런치 카페인데 분위기도 좋고 음식도 맛있어요! 특히 에그베네딕트가 일품입니다', 'RECOMMENDED', 'RESTAURANT', '대한민국', '서울특별시', 37.4979, 127.0276, 37.4979, 127.0276, '서울특별시 강남구 강남대로 지하', 37.4982, 127.0279, 35.1, 18, 8, 234, '2024-03-25 12:15:00', '2024-03-25 12:15:00', '2024-06-25 12:15:00'),

-- seoul_walker의 게시물 (4개)
(3, '한강 야경 포인트', '반포대교에서 보는 한강 야경이 정말 아름다워요. 데이트 코스로 강추합니다!', 'RECOMMENDED', 'ATTRACTIONS', '대한민국', '서울특별시', 37.5133, 127.0064, 37.5133, 127.0064, '서울특별시 서초구 반포동', 37.5136, 127.0067, 38.4, 23, 12, 145, '2024-03-28 20:30:00', '2024-03-28 20:30:00', '2024-06-28 20:30:00'),
(3, '명동 화장실 정보', '명동 쇼핑하다가 급할 때 쓸 수 있는 깨끗한 화장실 위치 공유해요', 'HELP', 'TOILET', '대한민국', '서울특별시', 37.5636, 126.9834, 37.5636, 126.9834, '서울특별시 중구 명동2가', 37.5639, 126.9837, 41.2, 9, 3, 78, '2024-03-30 15:40:00', '2024-03-30 15:40:00', '2024-06-30 15:40:00'),
(3, '건대 24시간 약국', '건대입구에서 밤늦게 약국 찾으시는 분들을 위해 24시간 운영하는 약국 정보 남겨요', 'HELP', 'PHARMACY', '대한민국', '서울특별시', 37.5403, 127.0694, 37.5403, 127.0694, '서울특별시 광진구 화양동', 37.5406, 127.0697, 33.7, 14, 6, 91, '2024-04-02 22:10:00', '2024-04-02 22:10:00', '2024-07-02 22:10:00'),
(3, '이태원 교통 주의!', '이태원 일대 도로공사로 인해 교통이 매우 혼잡해요. 대중교통 이용 추천합니다', 'WARNING', 'TRANSPORT', '대한민국', '서울특별시', 37.5346, 126.9947, 37.5346, 126.9947, '서울특별시 용산구 이태원동', 37.5349, 126.9950, 36.9, 11, 8, 134, '2024-04-05 16:25:00', '2024-04-05 16:25:00', '2024-07-05 16:25:00'),
...
(6, '성수동 감성 카페', '성수동에 새로 생긴 인더스트리얼 컨셉 카페예요. 분위기도 좋고 커피도 맛있어요!', 'RECOMMENDED', 'RESTAURANT', '대한민국', '서울특별시', 37.5447, 127.0557, 37.5447, 127.0557, '서울특별시 성동구 성수동1가', 37.5450, 127.0560, 34.6, 25, 11, 189, '2024-04-18 13:45:00', '2024-04-18 13:45:00', '2024-07-18 13:45:00'),
(6, '압구정 디저트 카페 실망', '압구정 로데오거리 디저트 카페 갔는데 가격 대비 맛이 별로였어요. 인스타용으로는 예쁘지만...', 'NOT_RECOMMENDED', 'RESTAURANT', '대한민국', '서울특별시', 37.5276, 127.0384, 37.5276, 127.0384, '서울특별시 강남구 신사동', 37.5279, 127.0387, 29.8, 8, 6, 102, '2024-04-20 16:20:00', '2024-04-20 16:20:00', '2024-07-20 16:20:00'),
(6, '홍대 ATM 위치 정보', '홍대에서 급하게 현금 필요할 때 쓸 수 있는 ATM 위치들 정리해서 올려요', 'HELP', 'ATM', '대한민국', '서울특별시', 37.5563, 126.9238, 37.5563, 126.9238, '서울특별시 마포구 홍익로', 37.5566, 126.9241, 32.4, 12, 4, 67, '2024-04-22 19:30:00', '2024-04-22 19:30:00', '2024-07-22 19:30:00'),

-- culture_hunter의 게시물 (2개)
(7, '국립중앙박물관 특별전', '국립중앙박물관에서 하고 있는 특별전이 정말 볼 만해요! 한국사에 관심 있으신 분들께 추천', 'RECOMMENDED', 'MUSEUM', '대한민국', '서울특별시', 37.5240, 126.9803, 37.5240, 126.9803, '서울특별시 용산구 서빙고로 137', 37.5243, 126.9806, 34.1, 18, 8, 145, '2024-04-25 11:00:00', '2024-04-25 11:00:00', '2024-07-25 11:00:00'),
(7, '대학로 공연 정보 질문', '대학로에서 뮤지컬 보려고 하는데 주차할 곳이 있을까요? 대중교통이 나을까요?', 'QUESTION', 'TRANSPORT', '대한민국', '서울특별시', 37.5820, 127.0006, 37.5820, 127.0006, '서울특별시 종로구 대학로', 37.5823, 127.0009, 33.2, 6, 9, 78, '2024-04-28 17:40:00', '2024-04-28 17:40:00', '2024-07-28 17:40:00'),
...
(9, '남산타워 사진 촬영 팁', '남산타워에서 야경 사진 찍는 베스트 포인트와 카메라 설정 팁 공유해요!', 'RECOMMENDED', 'ATTRACTIONS', '대한민국', '서울특별시', 37.5512, 126.9882, 37.5512, 126.9882, '서울특별시 용산구 용산동2가', 37.5515, 126.9885, 38.9, 31, 15, 267, '2024-05-08 19:20:00', '2024-05-08 19:20:00', '2024-08-08 19:20:00'),
(9, '경복궁 포토존', '경복궁에서 한복 입고 사진 찍기 좋은 포토존들 정리해서 올려요. 조명과 각도 팁도 함께!', 'RECOMMENDED', 'ATTRACTIONS', '대한민국', '서울특별시', 37.5796, 126.9770, 37.5796, 126.9770, '서울특별시 종로구 세종로', 37.5799, 126.9773, 31.4, 26, 13, 201, '2024-05-10 14:30:00', '2024-05-10 14:30:00', '2024-08-10 14:30:00'),
(9, '동대문 야경 촬영', '동대문 디자인 플라자 야경 촬영하고 왔어요. LED 조명이 정말 아름다워요!', 'RECOMMENDED', 'ATTRACTIONS', '대한민국', '서울특별시', 37.5669, 127.0092, 37.5669, 127.0092, '서울특별시 중구 을지로7가', 37.5672, 127.0095, 32.8, 19, 8, 154, '2024-05-12 21:00:00', '2024-05-12 21:00:00', '2024-08-12 21:00:00'),
(9, '광화문 날씨 주의', '광화문 광장 일대에 돌풍이 불고 있어요. 사진 촬영 계획 있으신 분들은 주의하세요!', 'WARNING', 'WEATHER', '대한민국', '서울특별시', 37.5720, 126.9769, 37.5720, 126.9769, '서울특별시 종로구 세종로', 37.5723, 126.9772, 29.1, 8, 4, 67, '2024-05-15 10:45:00', '2024-05-15 10:45:00', '2024-08-15 10:45:00'),

-- student_explorer의 게시물 (1개)
(10, '대학생 여행 꿀팁', '적은 예산으로도 알차게 여행하는 방법들 정리해서 공유해요! 숙박비 절약 팁부터 맛집까지', 'HELP', 'ACCOMMODATION', '대한민국', '서울특별시', 37.5490, 127.0761, 37.5490, 127.0761, '서울특별시 광진구 자양동', 37.5493, 127.0764, 35.3, 24, 18, 312, '2024-05-18 15:20:00', '2024-05-18 15:20:00', '2024-08-18 15:20:00');
